# Generated by Django 3.0.10 on 2020-10-01 00:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, help_text='An user account is active by default but is inactive if the staff suspend this account.')),
                ...
                ('follows', models.ManyToManyField(help_text='The accounts that this account is following.', through='accounts.Following', to='accounts.UserAccount')),
                ('user', models.OneToOneField(help_text='User owner of the account. It is mandatory.', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-created', '-modified'],
                'get_latest_by': ['-created', '-modified'],
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(help_text='This is an account that follow.', on_delete=django.db.models.deletion.CASCADE, related_name='following_account_from_account', to='accounts.UserAccount'),
        ),
        migrations.AddField(
            model_name='following',
            name='user_account_to',
            field=models.ForeignKey(help_text='This is an account that is followed.', on_delete=django.db.models.deletion.CASCADE, related_name='following_account_to_account', to='accounts.UserAccount'),
        ),
        migrations.AddConstraint(
            model_name='following',
            constraint=models.UniqueConstraint(fields=('user_account_from', 'user_account_to'), name='unique_user_account_from_user_account_to'),
        ),
    ]
